module github.com/showntop/llmack
...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/hunyuan v1.0.1080
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/tts v1.0.1080
