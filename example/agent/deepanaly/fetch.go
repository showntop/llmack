...
func fetchMyAudienceData(accounts []string, startDate, endDate time.Time) string {
	...
	tl.Invokex = func(ctx context.Context, params map[string]any) (string, error) {
		content, err := os.ReadFile("example/agent/deepanaly/my_audience_data.json")
		if err != nil {
			return "", err
		}
		...
		return buildMarkdownTable("audience", newRows), nil
	}
	tool.Register(tl)
	return tl.Name
}
...
func fetchMyPlacementData(accounts []string, startDate, endDate time.Time) string {
	...
	tl.Invokex = func(ctx context.Context, params map[string]any) (string, error) {
		content, err := os.ReadFile("example/agent/deepanaly/my_placement_data.json")
		if err != nil {
			return "", err
		}
		var rows []map[string]any
		...
		return buildMarkdownTable("placement", newRows), nil
	}
	tool.Register(tl)
	return tl.Name
}
...
func fetchMyCreativeData(accounts []string, startDate, endDate time.Time) string {
	...
	tl.Invokex = func(ctx context.Context, params map[string]any) (string, error) {
		content, err := os.ReadFile("example/agent/deepanaly/my_top_creative_data.json")
		if err != nil {
			return "", err
		}
		var rows []map[string]any
		...
		return buildMarkdownTable("creative", newRows), nil
	}
	tool.Register(tl)
	return tl.Name
}
...
func fetchMyRegionData(accounts []string, startDate, endDate time.Time) string {
	...
	tl.Invokex = func(ctx context.Context, params map[string]any) (string, error) {
		content, err := os.ReadFile("example/agent/deepanaly/my_top_region_data.json")
		if err != nil {
			return "", err
		}
		var rows []map[string]any
		...
		return buildMarkdownTable("region", newRows), nil
	}
	tool.Register(tl)
	return tl.Name
}
...
func fetchPeerPlacementData(accounts []string, startDate time.Time, endDate time.Time) string {
	...
	tl.Invokex = func(ctx context.Context, params map[string]any) (string, error) {
		content, err := os.ReadFile("example/agent/deepanaly/peer_placement_data.json")
		if err != nil {
			return "", err
		}
		var rows []map[string]any
...
func fetchPeerAudienceData(accounts []string, startDate, endDate time.Time) string {
	...
	tl.Invokex = func(ctx context.Context, params map[string]any) (string, error) {
		content, err := os.ReadFile("example/agent/deepanaly/peer_audience_data.json")
		if err != nil {
			return "", err
		}
		var rows []map[string]any
...
func fetchPeerRegionData(accounts []string, startDate, endDate time.Time) string {
	...
	tl.Invokex = func(ctx context.Context, params map[string]any) (string, error) {
		content, err := os.ReadFile("example/agent/deepanaly/peer_top_region_data.json")
		if err != nil {
			return "", err
		}
		var rows []map[string]any
...
func fetchPeerTopCreativeData(accounts []string, startDate, endDate time.Time) string {
	...
	tl.Invokex = func(ctx context.Context, params map[string]any) (string, error) {
		content, err := os.ReadFile("example/agent/deepanaly/peer_top_creative_data.json")
		if err != nil {
			return "", err
		}
		var rows []map[string]any
