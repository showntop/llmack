...
const critiqueExampleGeneratePrompt = `
...
const critiqueExampleOptimizationPrompt = `
...
[Question]: q1
[Answer]: <ANS_START>a1<ANS_END>
<END>
<START>
[Question]: q2
[Answer]: <ANS_START>a2<ANS_END>
<END>

[New Examples]:
`

const critiqueRefineMetaPrompt = `
