...
// NewAndroidAgent ...
func NewAndroidAgent(name string, options ...Option) *AndroidAgent {
	agent := &AndroidAgent{
...
func (agent *AndroidAgent) Invoke(ctx context.Context, task string, opts ...InvokeOption) *AgentRunResponse {
...
func (agent *AndroidAgent) invoke(ctx context.Context, task string, options *InvokeOptions) (*AgentRunResponse, error) {
...
// 迭代一次
func (agent *AndroidAgent) retry(ctx context.Context, task string, stream bool) (*AgentRunResponse, error) {
...
func (agent *AndroidAgent) getInitialMessages(_ context.Context, task string) []llm.Message {
...
func (agent *AndroidAgent) getBrowserState() string {
	toolx := tool.New(
...
func (agent *AndroidAgent) execActionTool(_ context.Context, customActions *controller.ActionModel) string {
...
func (agent *AndroidAgent) fetchOrCreateSession(ctx context.Context, sessionID string) (*storage.Session, error) {
